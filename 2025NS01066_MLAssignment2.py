...
plot_lc(axes[4], SVC(kernel='linear', C=0.1, class_weight='balanced',
                     probability=True, random_state=42),
...
axes[7].set_xlabel('Number of Trees')
axes[7].set_ylabel('Training Score')
...
axes[0].bar(
    ...
    color=plt.cm.RdYlGn(sleep_analysis['Pass_Rate'].values / 100),
